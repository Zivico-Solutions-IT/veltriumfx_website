      ...
      <section id="contact-info" className="py-12 lg:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          ...
          >
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3 text-sm text-emerald-50"><MapPin className="text-[#D3D3D3] w-5 h-5 shrink-0" /> <span>82 Buckingham Palace Rd, London SW1W 9TJ, UK</span></div>
            ...
            <a href="https://www.google.com/maps/search/?api=1&query=82+Buckingham+Palace+Rd+London+SW1W+9TJ+UK" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-full gap-2 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 py-3 text-sm font-bold text-white transition-colors hover:bg-white hover:text-[#00674F]">
              View on Maps
            </a>
          </motion.div>
        </div>
